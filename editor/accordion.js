...
export class TooltipType {
    ...
    constructor(type, text, icon, typeClass) {
        this.type = type;
        this.text = text;
        this.icon = icon;
...
export class AccordionRow {
     ...
     */
    constructor(accordion, id, type, title, content, onClick = () => { }) {
        this.type = type;
        this.id = id;
     ...
     * @param onClick - The function to be called when the row is clicked
     */
    constructHTML(title, content, type, onClick = () => { }) {
        this.contentContainer = DOMManupulation.createElement("div", "content-container", { "max-height": "0px" }, undefined, undefined, [content]);
        ...
        const typeContainer = DOMManupulation.createElement("div", ["type-container", type.typeClass], undefined, undefined, undefined, [icon, typeElement]);
        ...
        this.chevronElement = DOMManupulation.createElement("i", "expand-collapse-button", undefined, chevronDownIconSVG);
        // Header bar with chevron icon
        const headerContainer = DOMManupulation.createElement("div", "header-container", undefined, undefined, undefined, [textContainer, this.chevronElement]);
...
export class Accordion {
     ...
     * @param onClick - The function to be called when the row is clicked
     */
    addRow(type, title, content, onClick = () => { }) {
