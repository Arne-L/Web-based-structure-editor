...
export class ExecutableCode {
    // Can remove export
    static exampleCounter = 0;
    static openBoxes = [];
    static pressedEscape = false;
    ...
    static closeBox(id) {
        ...
        ExecutableCode.openBoxes.splice(ExecutableCode.openBoxes.findIndex((box) => box.id == id), 1);
        ...
        if (maxZIndexId)
            ExecutableCode.focusBox(maxZIndexId);
    ...
    static focusBox(id) {
        ...
        if (box && boxElement) {
            ...
            ExecutableCode.openBoxes.forEach((box) => {
                if (box.id != id) {
                    box.isFocused = false;
                    if (maxZIndexId != id && box.zIndex != INITIAL_Z_INDEX)
                        box.zIndex--;
                    ExecutableCode.setZIndex(box.id, box.zIndex);
                }
            });
...
class DocBoxMeta {
    ...
    isFocused;
    zIndex;
    constructor(id, isFocused, zIndex) {
        this.id = id;
...
//# sourceMappingURL=doc-box.js.map