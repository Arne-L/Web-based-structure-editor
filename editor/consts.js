...
(function (KeyPress) {
    // navigation:
    KeyPress["ArrowLeft"] = "ArrowLeft";
    KeyPress["ArrowRight"] = "ArrowRight";
    KeyPress["ArrowUp"] = "ArrowUp";
    KeyPress["ArrowDown"] = "ArrowDown";
    KeyPress["Home"] = "Home";
    KeyPress["End"] = "End";
    KeyPress["Tab"] = "Tab";
    // delete:
    ...
    KeyPress["Y"] = "y";
    //Typing sys
    KeyPress["OpenBracket"] = "[";
    KeyPress["OpenCurlyBraces"] = "{";
    KeyPress["Comma"] = ",";
    KeyPress["Plus"] = "+";
    KeyPress["ForwardSlash"] = "/";
    KeyPress["Star"] = "*";
    KeyPress["Minus"] = "-";
    KeyPress["GreaterThan"] = ">";
    KeyPress["LessThan"] = "<";
    KeyPress["Equals"] = "=";
 ...
 */
export var EditActionType;
(function (EditActionType) {
    EditActionType[EditActionType["DeleteStmt"] = 0] = "DeleteStmt";
    EditActionType[EditActionType["DeleteRootOfToken"] = 1] = "DeleteRootOfToken";
    EditActionType[EditActionType["InsertUniConstruct"] = 2] = "InsertUniConstruct";
    EditActionType[EditActionType["InsertGeneralExpr"] = 3] = "InsertGeneralExpr";
    EditActionType[EditActionType["Copy"] = 4] = "Copy";
    EditActionType[EditActionType["Paste"] = 5] = "Paste";
    EditActionType[EditActionType["Undo"] = 6] = "Undo";
    EditActionType[EditActionType["Redo"] = 7] = "Redo";
    EditActionType[EditActionType["MoveCursorLeft"] = 8] = "MoveCursorLeft";
    EditActionType[EditActionType["MoveCursorRight"] = 9] = "MoveCursorRight";
    EditActionType[EditActionType["MoveCursorStart"] = 10] = "MoveCursorStart";
    EditActionType[EditActionType["MoveCursorEnd"] = 11] = "MoveCursorEnd";
    EditActionType[EditActionType["DeleteNextChar"] = 12] = "DeleteNextChar";
    EditActionType[EditActionType["DeletePrevChar"] = 13] = "DeletePrevChar";
    EditActionType[EditActionType["DeleteListItem"] = 14] = "DeleteListItem";
    EditActionType[EditActionType["DeleteRootNode"] = 15] = "DeleteRootNode";
    EditActionType[EditActionType["ReplaceExpressionWithItem"] = 16] = "ReplaceExpressionWithItem";
    EditActionType[EditActionType["DeleteStringLiteral"] = 17] = "DeleteStringLiteral";
    EditActionType[EditActionType["DeleteToEnd"] = 18] = "DeleteToEnd";
    EditActionType[EditActionType["DeleteToStart"] = 19] = "DeleteToStart";
    EditActionType[EditActionType["SelectLeft"] = 20] = "SelectLeft";
    EditActionType[EditActionType["SelectRight"] = 21] = "SelectRight";
    EditActionType[EditActionType["SelectToStart"] = 22] = "SelectToStart";
    EditActionType[EditActionType["SelectToEnd"] = 23] = "SelectToEnd";
    EditActionType[EditActionType["SelectNextToken"] = 24] = "SelectNextToken";
    EditActionType[EditActionType["SelectPrevToken"] = 25] = "SelectPrevToken";
    EditActionType[EditActionType["SelectClosestTokenAbove"] = 26] = "SelectClosestTokenAbove";
    EditActionType[EditActionType["SelectClosestTokenBelow"] = 27] = "SelectClosestTokenBelow";
    EditActionType[EditActionType["InsertEmptyLine"] = 28] = "InsertEmptyLine";
    EditActionType[EditActionType["InsertEmptyList"] = 29] = "InsertEmptyList";
    EditActionType[EditActionType["InsertEmptyListItem"] = 30] = "InsertEmptyListItem";
    EditActionType[EditActionType["DeleteNextToken"] = 31] = "DeleteNextToken";
    EditActionType[EditActionType["DeletePrevToken"] = 32] = "DeletePrevToken";
    EditActionType[EditActionType["DeletePrevLine"] = 33] = "DeletePrevLine";
    EditActionType[EditActionType["DeleteBackMultiLines"] = 34] = "DeleteBackMultiLines";
    EditActionType[EditActionType["DeleteEmptyLine"] = 35] = "DeleteEmptyLine";
    EditActionType[EditActionType["DeleteStatement"] = 36] = "DeleteStatement";
    EditActionType[EditActionType["DeleteSelectedModifier"] = 37] = "DeleteSelectedModifier";
    EditActionType[EditActionType["DeleteMultiLineStatement"] = 38] = "DeleteMultiLineStatement";
    EditActionType[EditActionType["IndentBackwards"] = 39] = "IndentBackwards";
    EditActionType[EditActionType["IndentBackwardsIfStmt"] = 40] = "IndentBackwardsIfStmt";
    EditActionType[EditActionType["IndentForwards"] = 41] = "IndentForwards";
    EditActionType[EditActionType["IndentForwardsIfStmt"] = 42] = "IndentForwardsIfStmt";
    EditActionType[EditActionType["InsertChar"] = 43] = "InsertChar";
    EditActionType[EditActionType["None"] = 44] = "None";
    //typing actions
    EditActionType[EditActionType["InsertBinaryOperator"] = 45] = "InsertBinaryOperator";
    EditActionType[EditActionType["InsertUnaryOperator"] = 46] = "InsertUnaryOperator";
    EditActionType[EditActionType["InsertLiteral"] = 47] = "InsertLiteral";
    //displaying suggestion menu
    EditActionType[EditActionType["DisplayGreaterThanSuggestion"] = 48] = "DisplayGreaterThanSuggestion";
    EditActionType[EditActionType["DisplayLessThanSuggestion"] = 49] = "DisplayLessThanSuggestion";
    EditActionType[EditActionType["DisplayEqualsSuggestion"] = 50] = "DisplayEqualsSuggestion";
    //suggestion management
    EditActionType[EditActionType["SelectMenuSuggestionBelow"] = 51] = "SelectMenuSuggestionBelow";
    EditActionType[EditActionType["SelectMenuSuggestionAbove"] = 52] = "SelectMenuSuggestionAbove";
    EditActionType[EditActionType["SelectMenuSuggestion"] = 53] = "SelectMenuSuggestion";
    EditActionType[EditActionType["CloseValidInsertMenu"] = 54] = "CloseValidInsertMenu";
    EditActionType[EditActionType["OpenValidInsertMenu"] = 55] = "OpenValidInsertMenu";
    EditActionType[EditActionType["OpenSubMenu"] = 56] = "OpenSubMenu";
    EditActionType[EditActionType["CloseSubMenu"] = 57] = "CloseSubMenu";
    //TODO: Remove later (for the continuous menu with categories)
    // OpenValidInsertMenuSingleLevel,
    EditActionType[EditActionType["CloseDraftMode"] = 58] = "CloseDraftMode";
    EditActionType[EditActionType["InsertStatement"] = 59] = "InsertStatement";
    EditActionType[EditActionType["InsertExpression"] = 60] = "InsertExpression";
    EditActionType[EditActionType["WrapExpressionWithItem"] = 61] = "WrapExpressionWithItem";
    EditActionType[EditActionType["ConvertAutocompleteToString"] = 62] = "ConvertAutocompleteToString";
    EditActionType[EditActionType["InsertVarAssignStatement"] = 63] = "InsertVarAssignStatement";
    EditActionType[EditActionType["InsertVariableRef"] = 64] = "InsertVariableRef";
    EditActionType[EditActionType["InsertElseStatement"] = 65] = "InsertElseStatement";
    EditActionType[EditActionType["InsertModifier"] = 66] = "InsertModifier";
    EditActionType[EditActionType["InsertAssignmentModifier"] = 67] = "InsertAssignmentModifier";
    EditActionType[EditActionType["OpenAutocomplete"] = 68] = "OpenAutocomplete";
    EditActionType[EditActionType["InsertImportFromDraftMode"] = 69] = "InsertImportFromDraftMode";
    EditActionType[EditActionType["InsertTypeCast"] = 70] = "InsertTypeCast";
    EditActionType[EditActionType["InsertComparisonConversion"] = 71] = "InsertComparisonConversion";
    EditActionType[EditActionType["InsertFunctionConversion"] = 72] = "InsertFunctionConversion";
    EditActionType[EditActionType["InsertMemberCallConversion"] = 73] = "InsertMemberCallConversion";
    EditActionType[EditActionType["InsertMemberAccessConversion"] = 74] = "InsertMemberAccessConversion";
    EditActionType[EditActionType["InsertFormattedStringItem"] = 75] = "InsertFormattedStringItem";
    EditActionType[EditActionType["DeleteFStringCurlyBrackets"] = 76] = "DeleteFStringCurlyBrackets";
    EditActionType[EditActionType["InsertOperatorTkn"] = 77] = "InsertOperatorTkn";
    EditActionType[EditActionType["DeleteUnconvertibleOperandWarning"] = 78] = "DeleteUnconvertibleOperandWarning";
})(EditActionType || (EditActionType = {}));
export var ConstructName;
(function (ConstructName) {
    ConstructName["VarAssignment"] = "VarAssignmentStmt";
    ConstructName["Default"] = "Default";
 ...
 */
export var InsertActionType;
(function (InsertActionType) {
    InsertActionType[InsertActionType["InsertGeneralStmt"] = 0] = "InsertGeneralStmt";
    InsertActionType[InsertActionType["InsertGeneralExpr"] = 1] = "InsertGeneralExpr";
    InsertActionType[InsertActionType["InsertNewVariableStmt"] = 2] = "InsertNewVariableStmt";
    InsertActionType[InsertActionType["InsertStatement"] = 3] = "InsertStatement";
    InsertActionType[InsertActionType["InsertExpression"] = 4] = "InsertExpression";
    InsertActionType[InsertActionType["InsertElifStmt"] = 5] = "InsertElifStmt";
    InsertActionType[InsertActionType["InsertElseStmt"] = 6] = "InsertElseStmt";
    InsertActionType[InsertActionType["InsertFormattedStringItem"] = 7] = "InsertFormattedStringItem";
    InsertActionType[InsertActionType["InsertPrintFunctionStmt"] = 8] = "InsertPrintFunctionStmt";
    InsertActionType[InsertActionType["InsertRangeExpr"] = 9] = "InsertRangeExpr";
    InsertActionType[InsertActionType["InsertLenExpr"] = 10] = "InsertLenExpr";
    InsertActionType[InsertActionType["InsertCastStrExpr"] = 11] = "InsertCastStrExpr";
    InsertActionType[InsertActionType["InsertInputExpr"] = 12] = "InsertInputExpr";
    InsertActionType[InsertActionType["InsertListLiteral"] = 13] = "InsertListLiteral";
    InsertActionType[InsertActionType["InsertListItem"] = 14] = "InsertListItem";
    InsertActionType[InsertActionType["InsertLiteral"] = 15] = "InsertLiteral";
    InsertActionType[InsertActionType["InsertUnaryExpr"] = 16] = "InsertUnaryExpr";
    InsertActionType[InsertActionType["InsertBinaryExpr"] = 17] = "InsertBinaryExpr";
    InsertActionType[InsertActionType["InsertListAppendMethod"] = 18] = "InsertListAppendMethod";
    InsertActionType[InsertActionType["InsertListIndexAccessor"] = 19] = "InsertListIndexAccessor";
    InsertActionType[InsertActionType["InsertListIndexAssignment"] = 20] = "InsertListIndexAssignment";
    InsertActionType[InsertActionType["InsertStringSplitMethod"] = 21] = "InsertStringSplitMethod";
    InsertActionType[InsertActionType["InsertStringJoinMethod"] = 22] = "InsertStringJoinMethod";
    InsertActionType[InsertActionType["InsertStringReplaceMethod"] = 23] = "InsertStringReplaceMethod";
    InsertActionType[InsertActionType["InsertStringFindMethod"] = 24] = "InsertStringFindMethod";
    InsertActionType[InsertActionType["InsertAssignmentModifier"] = 25] = "InsertAssignmentModifier";
    InsertActionType[InsertActionType["InsertAugmentedAssignmentModifier"] = 26] = "InsertAugmentedAssignmentModifier";
    InsertActionType[InsertActionType["InsertVarOperationStmt"] = 27] = "InsertVarOperationStmt";
    InsertActionType[InsertActionType["InsertValOperationExpr"] = 28] = "InsertValOperationExpr";
    InsertActionType[InsertActionType["InsertOperatorTkn"] = 29] = "InsertOperatorTkn";
...
export class Actions {
    ...
    constructor() {
        ...
        this.actionsMap = new Map(this.actionsList.map((action) => [action.cssId, action])); // Automatically done
...
(function (CodeStatus) {
    CodeStatus[CodeStatus["ContainsEmptyHoles"] = 0] = "ContainsEmptyHoles";
    CodeStatus[CodeStatus["ContainsAutocompleteTokens"] = 1] = "ContainsAutocompleteTokens";
    CodeStatus[CodeStatus["ContainsDraftMode"] = 2] = "ContainsDraftMode";
    CodeStatus[CodeStatus["Empty"] = 3] = "Empty";
    CodeStatus[CodeStatus["Runnable"] = 4] = "Runnable";
})(CodeStatus || (CodeStatus = {}));
export class ToolboxCategory {
    displayName;
    id;
    items = [];
    constructor(displayName, id, items) {
        this.displayName = displayName;
        this.id = id;
        this.items = items;
    }
    addEditCodeAction(action) {
...
export class VarAction {
    ...
    group;
    action;
    constructor(action, description, group) {
        this.action = action;
