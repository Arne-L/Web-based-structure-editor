import { EditableTextTkn, 
// EmptyOperatorTkn,
// ForStatement,
IdentifierTkn, 
// OperatorTkn,
HoleTkn, } from "../syntax-tree/ast";
...
export class Hole {
    ...
    constructor(editor, code) {
        ...
        if (code instanceof IdentifierTkn)
            this.element.classList.add("identifier-hole");
        ...
        if (code instanceof EditableTextTkn || code instanceof IdentifierTkn /*|| code instanceof OperatorTkn*/) {
            ...
            code.subscribe(CallbackType.focusEditableHole, new Callback(() => {
        ...
        //     })
        // );
        code.subscribe(CallbackType.fail, new Callback(() => {
     ...
     */
    static outlineTextEditableHole(context) {
