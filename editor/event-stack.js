...
(function (EventType) {
    EventType[EventType["OnKeyDown"] = 0] = "OnKeyDown";
    EventType[EventType["OnButtonDown"] = 1] = "OnButtonDown";
    EventType[EventType["OnMouseMove"] = 2] = "OnMouseMove";
    EventType[EventType["OnDidScrollChange"] = 3] = "OnDidScrollChange";
    EventType[EventType["OnCursorPosChange"] = 4] = "OnCursorPosChange";
})(EventType || (EventType = {}));
/**
...
export class EventStack {
    ...
    // }
    attachOnButtonPress() {
        const buttons = Array(...document.querySelectorAll("#editor-toolbox  .button"));
    ...
    attachOnCursorPosChange() {
        ...
        module.editor.monaco.onDidChangeCursorPosition((e) => {
